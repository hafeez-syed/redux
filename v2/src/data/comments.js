const comments = {
  ...
  "BAcyDyQwcXX":[
    {
      "text":"Hafeez. WE should have lunch.",
      "user": "jdaveknox"
    },
    {
      "text":"#adults",
  ...
  "BAPIPRjQce9":[
    ...
    {
      "text":"@hafeezsyed 👍 my daughter is a pancake eating machine!",
      "user": "brentoage"
    },
    {
      "text":"Nice stove!",
  ...
  "BAF_KY4wcRY":[
    {
      "text":"Looking great Hafeez! I'd like to see the other side of the room too.",
      "user": "axcdnt"
    },
    {
    ...
    {
      "text":"@hafeezsyed is that the Dell 4k? The MacBook Pro powers it well? I also have a Retina™ / x1 setup as well. Very handy.",
      "user": "henrihelvetica"
    },
    {
      "text":"#minimalsetups",
  ...
  "hZh6IQcfN":[
    {
      "text":"What do we gotta do to get some :)? @hafeezsyed",
      "user": "jonasbad"
    },
    {
      "text":"Might drop by today - real quick. Trade you an illegal pin for these? Lol. @hafeezsyed",
      "user": "henrihelvetica"
    },
    {
